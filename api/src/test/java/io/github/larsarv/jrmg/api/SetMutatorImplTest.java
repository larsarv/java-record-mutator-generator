...
class SetMutatorImplTest {
    ...
    void shouldSetElementInSet() {
        ...
        var mutator = new SetBuilderImpl<>(Set.copyOf(originalList), StringRecordMutator::new);
    ...
    void shouldAddElementToSet() {
        ...
        var mutator = new SetBuilderImpl<>(originalSet, StringRecordMutator::new);
    ...
    void shouldReturnImmutableSetCopyOnBuild() {
        ...
        SetBuilderImpl<TestRecord, TestRecordMutator> mutator = new SetBuilderImpl<>(originalSet, TestRecordMutator::new);
    ...
    void shouldHandleNullSetInConstructor() {
        // Arrange
        SetBuilderImpl<TestRecord, TestRecordMutator> mutator = new SetBuilderImpl<>(null, TestRecordMutator::new);
