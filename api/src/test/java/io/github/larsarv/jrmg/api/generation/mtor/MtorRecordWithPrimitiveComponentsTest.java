...
class MtorRecordWithPrimitiveComponentsTest {
    private static final MtorRecordWithPrimitiveComponents TEST_RECORD = new MtorRecordWithPrimitiveComponents(
            true,
            (byte) 1,
            'a',
            (short) 1,
    ...
    void booleanComponentShouldRetainOriginalValue() {
        // Arrange
        var mutator = MtorRecordWithPrimitiveComponentsMtor.mutator(TEST_RECORD);
        // Act
        MtorRecordWithPrimitiveComponents builtRecord = mutator.build();
        // Assert
    ...
    void booleanComponentShouldGetNewValue() {
        // Arrange
        var mutator = MtorRecordWithPrimitiveComponentsMtor.mutator();
        // Act
        MtorRecordWithPrimitiveComponents builtRecord = mutator
